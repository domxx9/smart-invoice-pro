...
export const ACCENT_PRESETS = ['#f5a623','#e05252','#4caf84','#64a0ff','#9b59b6','#1abc9c','#e67e22','#2c3e50']

export const COLOUR_PRESETS = {
  primary:   ['#f5a623','#4caf84','#64a0ff','#e05252','#a855f7','#ec4899','#14b8a6','#f97316'],
  secondary: ['#1e1e1e','#0f172a','#1e3a5f','#1a0a2e','#0d2a1e','#1a0000','#0a1628','#2a2000'],
  tertiary:  ['#f5f5f5','#f0f4ff','#f0fdf4','#fdf4ff','#fff7ed','#fef2f2','#f0fdfa','#fffbeb'],
}

                  ...
                  return (
                    ...
                    >
                      {isGreen && (
                        ...
                        >
                          <div style={{ flex: 1, minWidth: 0 }}>
                            ...
                            <div
                              style={{ fontSize: '.72rem', color: 'var(--muted)', marginTop: 2 }}
                            >
                              {r.aiEnhanced ? '🤖 AI matched' : `${r.confidence}% match`} ·{' '}
                              {fmt(prod.price)} each
                              {s === 'confirmed' && (
                      ...
                      {isAmber && (
                        <div>
                          <div
                            style={{ fontSize: '.78rem', color: 'var(--muted)', marginBottom: 2 }}
                          >
                      ...
                      {isRed && (
                        ...
                        >
                          <div style={{ fontSize: '.82rem', color: 'var(--danger)' }}>
                            ...
                            {s === 'discarded' && (
                              <span
                                style={{ fontSize: '.72rem', color: 'var(--muted)', marginLeft: 6 }}
                              >
                                Discarded
                              </span>
                            )}
              ...
              {filteredGroups.map((g, gi) => {
                ...
                return (
                  ...
                  >
                    {single && (
                      <div
                        onClick={() => addProduct(g.variants[0])}
                        style={{
                          padding: '10px 12px',
                          cursor: 'pointer',
                          display: 'flex',
                      ...
                      >
                        ...
                        <span
                          style={{ color: 'var(--accent)', fontWeight: 600, fontSize: '.85rem' }}
                        >
